...
///支付宝Native
class AlipayNativePage extends StatefulWidget {
  @override
  AlipayNativePageState createState() => AlipayNativePageState();
}

class AlipayNativePageState extends State<AlipayNativePage> {
  List<String> temp = [
  ...
  void invokePay() async {
    String value = await YinPay.invokeAlipayByNative(orderInfo);
    result = value;
    setState(() {});
  }
}
